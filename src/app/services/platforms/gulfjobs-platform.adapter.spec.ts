...
describe('GulfJobsPlatformAdapter', () => {
  let adapter: GulfJobsPlatformAdapter;

  beforeEach(() => {
    TestBed.configureTestingModule({});
    adapter = TestBed.inject(GulfJobsPlatformAdapter);
  });
  ...
  describe('static properties', () => {
    it('should have correct id', () => {
      expect(adapter.id).toBe('gulfjobs');
    });

    it('should have correct label', () => {
      expect(adapter.label).toBe('GulfJobs');
    });
  ...
  describe('buildUrl', () => {
    ...
    it('should use gulfjobs.com domain', () => {
      const url = adapter.buildUrl(createPayload(), 'Developer');
      expect(url).toContain('gulfjobs.com');
    });
  });
